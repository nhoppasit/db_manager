...
use kasetfms
GO
/****** Object:  StoredProcedure [dbo].[Sp_CommonPreparing_Deactivate]    Script Date: 9/18/2018 7:17:10 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	begin try
		...
		BEGIN
			...
			set @MessageResult = 'ยกเลิกข้อมูลกิจกรรมการตามตารางงาน-กำจัดวัชพืช เรียบร้อยแล้ว';
			return 0
		END
